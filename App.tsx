  ...
  return (
    <div className="min-h-screen relative overflow-hidden text-slate-800 selection:bg-blue-100 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        {/* QUAN TRỌNG: Thêm items-start để Sidebar có không gian trượt (Sticky) */}
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          
          {/* LEFT SIDEBAR: Chế độ Sticky (Tự trôi theo web) */}
          <aside className="w-full lg:w-80 lg:sticky lg:top-8 flex-shrink-0 z-10">
          ...
          {/* RIGHT CONTENT: Dashboard (Nội dung chính sẽ cuộn dài) */}
      ...
      {/* Footer */}
      <footer className="mt-24 py-8 text-center text-slate-400 text-sm relative z-20">
